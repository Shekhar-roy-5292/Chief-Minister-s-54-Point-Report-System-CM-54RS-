...
<body>
    <a id="back" class="back" href="{{ route('users.userDashboard') }}" class="btn btn-light">Back</a>
    <form action="{{ route('users.downloadCMReport') }}" method="POST">
        ...
        <input id="submit" type="submit" class="btn btn-success" value="Download excel report">
    </form>
    <br>
    <table>
        <thead>
